        ...
        <div class="p-4 max-w-7xl">
            <div class="mx-auto w-full max-w-md space-y-8 rounded-2xl bg-card p-8">
                <div class="text-center">
                  ...
                  <p class="text-muted-foreground">Inicia sesión en tu cuenta para continuar</p>
                </div>
                <form class="space-y-6 flex flex-col gap-1">
                  ...
                  <div>
                    <div class="flex items-center justify-between">
                      ...
                      <a class="text-sm font-medium underline underline-offset-4 hover:text-primary" href="/">
